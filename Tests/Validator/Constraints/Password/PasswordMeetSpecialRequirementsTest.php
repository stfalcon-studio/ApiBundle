...
final class PasswordMeetSpecialRequirementsTest extends TestCase
{
    public function testGetTargets(): void
    {
        self::assertSame(Constraint::PROPERTY_CONSTRAINT, (new PasswordMeetSpecialRequirements())->getTargets());
    }
}
